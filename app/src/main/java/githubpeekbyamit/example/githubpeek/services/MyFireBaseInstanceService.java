package githubpeekbyamit.example.githubpeek.services;
...
import githubpeekbyamit.example.githubpeek.R;
...
public class MyFireBaseInstanceService extends FirebaseMessagingService {
    ...
    private void  showNotification (Map<String,String> data) {
        ...
        String NOTIFICATION_CHANNEL_ID = "githubpeekbyamit.example.services.test";
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O)
        {
            NotificationChannel notificationChannel = new NotificationChannel ( NOTIFICATION_CHANNEL_ID,"Notification",
                    NotificationManager.IMPORTANCE_DEFAULT);
            notificationChannel.setDescription ( "heritsm_heritageofindia" );
